...
Always provide direct, structured, and actionable supply chain guidance with dollar savings and operational steps.
"""

def query_groq_llm(user_message: str, chat_history: List[Dict[str, str]] = None) -> str:
    ...
    try:
        r = session.post(GROQ_URL, headers=headers, json=payload, timeout=6)
    ...
    # Built-in SOP Knowledge-Grounded Fallback Engine
    msg_lower = user_message.lower()
    
    if "demurrage" in msg_lower or "port" in msg_lower or "rotterdam" in msg_lower:
        return (
        ...
        return (
            ...
            f"I have reviewed your query against the **NexaFreight Business SOP Knowledge Base** (172,765 shipment records & XGBoost ML Regressor).\n\n"
