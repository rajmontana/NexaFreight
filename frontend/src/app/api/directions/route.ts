...
/**
 * NexaFreight — Turn-by-turn Directions API
 *
...
/** Minimal shapes of the upstream payloads — only the fields NexaFreight reads. */
...
export async function GET(request: Request) {
  try {
    ...
    console.error('[NexaFreight] Directions error:', error);
