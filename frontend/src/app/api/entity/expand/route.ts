...
/**
 * Thin proxy to the NexaFreight Intelligence Layer (NexaFreight-intel).
 *
 * In Docker: fetches from http://NexaFreight-intel:4000/resolve
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[NexaFreight] Intel proxy error:', e instanceof Error ? e.message : e);
    return NextResponse.json(
